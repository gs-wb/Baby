...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF0323130;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF9F9C99;

	/** Top and bottom shadows colors */
//	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111,
//			0x00AAAAAA, 0x00AAAAAA };
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFF5F0EB,
		0x00F5F0EB, 0x00F5F0EB };
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFF5F0EB);
		}
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (!isScrollingPerformed
			...
			String text = getAdapter() != null ? getAdapter().getItem(
					currentItem) : null;
			valueLayout = new StaticLayout(text != null ? text.length()==1?"0"+text:text : "",
	...
	private void drawShadows(Canvas canvas) {
		topShadow.setBounds(0, 0, getWidth(), getHeight() / visibleItems+100);
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, getHeight() - getHeight() / visibleItems-100,
				getWidth(), getHeight());
