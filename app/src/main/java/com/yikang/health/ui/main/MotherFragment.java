...
import com.yikang.health.ui.circle.CirclePageIndicator;
import com.yikang.health.ui.circle.GridViewFaceAdapter;
import com.yikang.health.ui.circle.JazzyViewPager;
import com.yikang.health.ui.circle.JazzyViewPager.TransitionEffect;
import com.yikang.health.ui.circle.ViewPagerAdapter;
import com.yikang.health.utils.SharePreferenceUtil;
import com.yikang.health.widget.MyEditText;

public class MotherFragment extends BaseFragment implements OnClickListener {
	public static MotherFragment instance;
	...
	private void initComponent(View v) {
		lvCircle = (ListView) v.findViewById(R.id.lv_circle);
		workcircleReplyLayout = (View) v
				.findViewById(R.id.workcircleReplyLayout);
		msg_express = (ImageButton) v.findViewById(R.id.msg_express);
		msg_express.setTag(1);
		msg_submit = (Button)v.findViewById(R.id.msg_submit);
        msg_content = (MyEditText)v.findViewById(R.id.msg_content);
	...
	private void initFaceView(View v){
		mSpUtil = YIKApplication.instance.getSpUtil();
        facelayout = (RelativeLayout)v.findViewById(R.id.facelayout);
        tabpager = (JazzyViewPager)v.findViewById(R.id.tabpager);
        Set<String> keySet = YIKApplication.instance.getmFaceMap().keySet();
        keys = new ArrayList<String>();
        keys.addAll(keySet);
    }
	
	private void loadFace(View v) {
	...
	private GridView getGridView(int i) {
		...
		gv.setAdapter(new GridViewFaceAdapter(getActivity(), i));
