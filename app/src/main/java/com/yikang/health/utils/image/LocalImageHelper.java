...
import com.yikang.health.utils.StringUtils;
...
public class LocalImageHelper {
    ...
    private final YIKApplication context;
    ...
    public String setCameraImgPath() {
        String foloder = YIKApplication.instance.getCachePath()
                + "/PostPicture/";
    ...
    private LocalImageHelper(YIKApplication context) {
    ...
    public static void init(YIKApplication context) {
